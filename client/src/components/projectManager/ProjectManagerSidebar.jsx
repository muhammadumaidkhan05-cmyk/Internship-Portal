...
const navigationItems = getNavItems(ROLES.PROJECT_MANAGER).filter(
...
function ProjectManagerSidebar({
  ...
  const handleLogout = () => {
    ...
    // Go only to Project Manager logout route
    // Never use "/" because "/" opens Program Manager dashboard.
    navigate("/project-manager/logout", {
      replace: true,
    });
  };
