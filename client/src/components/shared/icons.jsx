...
export function IconUsers({ size = 18, ...p }) {
  return (
    <svg {...base(size)} {...p}>
...
export function IconPrograms({ size = 18, ...p }) {
  return (
    <svg {...base(size)} {...p}>
...
export function IconSettings({ size = 18, ...p }) {
  return (
    <svg {...base(size)} {...p}>
...
export function IconProfile({ size = 18, ...p }) {
  return (
    <svg {...base(size)} {...p}>
...
export function IconLogout({ size = 18, ...p }) {
  return (
    <svg {...base(size)} {...p}>
...
export function IconChevronDown({ size = 14, ...p }) {
  return (
    <svg {...base(size)} {...p}>
...
export function IconHeartPulse({ size = 18, ...p }) {
  return (
    <svg {...base(size)} {...p}>
...
export function IconClipboard({ size = 18, ...p }) {
  return (
    <svg {...base(size)} {...p}>
