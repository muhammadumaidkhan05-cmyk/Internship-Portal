...
// Roles & Labels
// Aligned with lib/roles.js and the server's canonical role list.
// "project_manager" was missing here, which meant the Super Admin
// user form could not create a Project Manager.
export const ROLES = [
  "super_admin",
  "program_manager",
  "project_manager",
