...
import { REGISTER_ROLE_OPTIONS, ROLES } from "../../lib/roles";
          ...
          >
            ...
            {success && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.3 }}
                className="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-medium text-[#047857]"
              >
                {success}
              </motion.div>
            )}
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-slate-500">
                Super Admin accounts are created by an existing administrator.
              </p>
            </div>
